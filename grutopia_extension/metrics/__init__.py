...
for module in [
    'grutopia_extension.metrics.candidates_reduce_metric',
    'grutopia_extension.metrics.debug_metric',
    'grutopia_extension.metrics.mobile_manipulation_success_metric',

...
@pytest.mark.P0
def test_rep_camera_pose():
    start_command = 'python ./tests/rep_camera_pose.py'
    common_body(start_command)


@pytest.mark.P0
def test_h1_locomotion_multi_sim():
    start_command = 'python ./tests/h1_locomotion_multi_sim.py'
    common_body(start_command)
